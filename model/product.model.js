...
const productSchema = mongoose.Schema({
    ...
    gender: { type: String, default: "demo", enum: ["demo", "Male", "Female", "Unisex"] },
    category: {
        type: String, defailt: "demo", enum: ["demo", 'Clothing', 'Shoes', 'Handbags', 'Accessories', 'Sunglasses', 'Jewelry'],
        required: true
    },
    subCategoryCloth: {
        type: String, defailt: "demo", enum: ["demo", "Activewear", "Coats & Jackets", "Dresses", "Jeans & Denim", "Jumpsuits & Rompers", "Lingerie & Hosiery",
    ...
    subCategoryShoes: {
        type: String, defailt: "demo", enum: ["demo", "Boots", "Espadrilles", "Flats", "Mules & Slides", "Oxfords & Loafers", "Pumps & Heels", "Sandals", "Slippers",
    ...
    subCategoryHandbag: {
        type: String, defailt: "demo", enum: ["demo", "Celine", "Chloe", "Givenchy", "Mario Valentino", "Prada", "Stella McCartney", "Bucket-bags",
            "Clutches", "Crossbody Bags", "Hobo Bags", "Satchels", "Shoulder Bags", "Tote Bags", "Travel Bags & Luggage",
            "Women's Wallets & Cardholders"]
    },
    subCategorySunglass: {
        type: String, defailt: "demo", enum: ["demo", "Carrera", "Dior", "Ermenegildo Zegna", "Montblanc", "Persol", "Tom Ford", "Emilio Pucci",
            "Fendi", "Oliver Peoples", "Roberto Cavalli"]
    },
    subCategoryDesigners: {
        type: String, defailt: "demo", enum: ["demo", "Moschino", "Off-White", "Palm Angels", "Tod'S", "Vince"]
    },
    subCategoryJewelryWatch: {
        type: String, defailt: "demo", enum: ["demo", "Michael Kors", "Red Line", "Bracelets", "Brooches & Pins", "Earrings", "Necklaces",
            "Rings", "Watches", "Men's Jewelry"]
    },
    subCategoryAccessories: {
        type: String, defailt: "demo", enum: ["demo", "Belts", "Hats", "Optical & Reading Glasses", "Scarves", "Bag Charms, Straps, & Accessories",
